		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Urlaubsplaner",
									"targetURL": "#urlaubsplanerurlaubsplaner-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"urlaubsplanerurlaubsplaner-display": {
								"semanticObject": "urlaubsplanerurlaubsplaner",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=urlaubsplaner.urlaubsplaner",
									"url": sap.ui.require.toUrl("urlaubsplaner/urlaubsplaner")
								}
							}
						}
					}
